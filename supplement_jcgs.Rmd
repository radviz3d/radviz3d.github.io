...
ceramic.palette  <-  brewer.pal(12,"Paired")[c(1:6,9,10)]
ceramic.palette  <- as.vector(apply(matrix(ceramic.palette, nrow = 2), 2, 
...
modradviz2d(x = df[,-c(1,2)][ll], cl = factor(df$era), modify = F, 
            ...
            palette = ceramic.palette, pch = c(16,17)[factor(df$mf)],
            opt.axis.order = F)
```
<br />
RadViz2D
