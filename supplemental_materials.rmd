...
for (i in 1:length(omegas)){
  ...
  umap_res <- umap(as.matrix(sn.df[,-ncol(sn.df)]), n_components = 3, y = sn.df[,ncol(sn.df)], target_weight = 0)
...
for (i in 1:length(omegas)){
  sn.df <- sim_data[[i]]
  radialvis3d(data = sn.df[,-ncol(sn.df)], cl = as.factor(sn.df[,ncol(sn.df)]), domrp = T, doGtrans = T, lwd = 2, alpha = 0.35, pradius = 0.01, color = brewer.pal(5, "Paired"), message = F)
...
# Radviz3d, Viz3D, 3D UMAP, 3D tSNE and Star coordinate plots with OLDA and ULDA
...
<td align="center" valign="center">
```{r}
radialvis3d(data = sndf[,-ncol(sndf)], cl = sndf[,ncol(sndf)], domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = df.palette)
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
rgl::rgl.viewpoint(zoom = 0.6)
rgl::rglwidget()
...
```{r}
load("datasets/zipdf.rda")
radialvis3d(data = zipdigit[, -ncol(zipdigit)], cl = zipdigit[,ncol(zipdigit)], domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = zip.palette)
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
rgl::rgl.viewpoint(zoom = 0.6)
rgl::rglwidget()
...
```{r}
load("datasets/facedf.rda")
radialvis3d(data = facedf[, -ncol(facedf)], cl = facedf[,ncol(facedf)], domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = df.palette, class.labels = c("A", "B", "C", "D", "E", "F"))
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
# legend3d("topright", legend = c("Normal", "ASD subject"), pch = 19, col = senator.palette, cex=0.8, inset=c(0.01))
rgl::rgl.viewpoint(zoom = 0.6)
...
<td align="center" valign="center">
```{r}
load('datasets-gdt/just_normal.Rda')
sn.df <- simd_normal_class
class <- as.factor(sn.df$class)
sn <- sn.df[,-1]
sn.df <- data.frame(sn,class)
set.seed(1)
tsne <- Rtsne(as.matrix(sn.df[,-157]), dims = 3, 
              perplexity=min(500,floor((nrow(sn.df)-1)/3)), 
              check_duplicates = F,  
              verbose=F, max_iter = 500)
res1 = tsne$Y
...
```{r}
set.seed(1)
umap_res <- umap(as.matrix(sn.df[,-157]), n_components =  3, y = sn.df[,157])
res1 = data.frame(umap_res, class)
colnames(res1) = c("x","y","z","class")
# open 3d window
...
<td align="center" valign="center">
```{r}
out2 = do.olda(as.matrix(sn.df[,-157]), ndim = 4, class)
...
<td align="center" valign="center">
```{r}
out2 = do.ulda(as.matrix(sn.df[,-157]), ndim = 4, class)
...
```{r}
load("datasets/senatordf.rda")
radialvis3d(data = sndf[, -ncol(sndf)], cl = sndf[,ncol(sndf)], domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = senator.palette, class.labels = c("Democratic", "Republican"))
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
rgl::rgl.viewpoint(zoom = 0.6)
rgl::rglwidget()
...
```{r}
load("datasets/autismdf.rda")
radialvis3d(data = sndf[, -ncol(sndf)], cl = sndf[,ncol(sndf)], domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = senator.palette, class.labels = c("Normal", "ASD subject"))
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
# legend3d("topright", legend = c("Normal", "ASD subject"), pch = 19, col = senator.palette, cex=0.8, inset=c(0.01))
rgl::rgl.viewpoint(zoom = 0.6)
...
```{r}
load("datasets/spectdf.rda")
radialvis3d(data = sndf[, -ncol(sndf)], cl = sndf[,ncol(sndf)], domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = senator.palette, class.labels = c("Normal", "Abnormal"))
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
# legend3d("topright", legend = c("Normal", "ASD subject"), pch = 19, col = senator.palette, cex=0.8, inset=c(0.01))
rgl::rgl.viewpoint(zoom = 0.6)
...
```{r}
load("datasets/scriptdf.rda")
radialvis3d(data = scriptdf[, -ncol(scriptdf)], cl = scriptdf[,ncol(scriptdf)], domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = script.palette, class.labels = c("Bangla", "Gujarati", "Gurmukhi", "Kannada", "Malayalam", "Urdu"))
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
# legend3d("topright", legend = c("Normal", "ASD subject"), pch = 19, col = senator.palette, cex=0.8, inset=c(0.01))
rgl::rgl.viewpoint(zoom = 0.6)
...
```{r}
load("datasets/gtexdf.rda")
radialvis3d(data = sndf[, -ncol(sndf)], cl = as.factor(sndf[,ncol(sndf)]), domrp = F, doGtrans = F, lwd = 2, alpha = 0.35, pradius = 0.01, color = gtex.palette, class.labels = c("Breast", "Colon", "Esophagus", "Liver", "Lung", "Prostate", "Stomach", "Thyrioid"))
# rgl::par3d(windowRect = c(0, 0, 1200, 1200))
# rgl::par3d(viewport = c(0,0,1200, 1200))
# legend3d("topright", legend = c("Normal", "ASD subject"), pch = 19, col = senator.palette, cex=0.8, inset=c(0.01))
rgl::rgl.viewpoint(zoom = 0.6)
